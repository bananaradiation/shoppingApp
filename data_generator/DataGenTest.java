...
{	
		...
		DataGenTest dg=new DataGenTest();
	...
	public void createData(int Num_users,int Num_categories, int Num_products,int Num_sales ) throws Exception
	{
		 ...
		 DataTest db=new DataTest();
	     db.openConn();
	     db.openStatement();
	     db.init();//create tables

	     // CHANGE PATHS FOR WRITE FILES
	     String  usersPath		=	"/home/hannahchen/workspace/shoppingApp/users_test.txt",
	    		 categoriesPath	=	"/home/hannahchen/workspace/shoppingApp/categories_test.txt",
	    		 productsPath	=	"/home/hannahchen/workspace/shoppingApp/products_test.txt",
	     		 salesPath		=	"/home/hannahchen/workspace/shoppingApp/sales_test.txt";
